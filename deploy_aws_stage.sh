...
webRootPath="/var/www/nupod_stage"
deployPath="/var/www/nupod_stage"
...
sudo systemctl stop nupod_stage.service
...
sudo systemctl start nupod_stage.service
sudo systemctl status nupod_stage.service
